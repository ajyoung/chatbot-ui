...
AS $$
DECLARE
  project_url TEXT := 'https://bmzhjclcgdzxbxbkdmmi.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJtemhqY2xjZ2R6eGJ4YmtkbW1pIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDY0OTE2NCwiZXhwIjoyMDUwMjI1MTY0fQ.fgSjnwR5KIBa9UQ7fIIBLmUaAmDg70p37jhaw_B6llI'; -- full access needed for http request to storage
